...
var displayMap = function displayMap(locations) {
  ...
  var map = new mapboxgl.Map({
    ...
    scrollZoom: false,
    zoom: 5 // center: [-73.970348, 40.785725],
    // zoom: 10,
    // interactive: false
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', "We glad we have you in our society!\nRedirecting you to the main page in a second...");
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', "Your're now logged in successfully!\nRedirecting you to the main page in a second...");
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', 'Error while logging out! Try again.');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', "Your ".concat(type.toUpperCase(), " has updated successfully!"));
            }
...
var stripe = Stripe('pk_test_51HMBEnAkcNnX5JwLwAFTg9FGuOuqI2Svp97tCDHLcDC9Cn7RBwgD3X2xnbsOAqFTP4pUwhLFBfVZ3j3hLbHelt6U00tNiWJDcX');
...
if (bookBtn) bookBtn.addEventListener('click', function (e) {
  ...
  var tourId = document.getElementById('book-tour').dataset.tourId;
  (0, _stripe.bookTour)(tourId);
});
var alertMessage = document.querySelector('body').dataset.alert;
if (alert) (0, _alert.showAlert)('success', alertMessage, 20);
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "13469" + '/');
